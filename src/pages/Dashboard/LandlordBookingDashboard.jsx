...
const LandlordBookingDashboard = () => {
  ...
  const handleEdit = (booking) => {
    // Logic chỉnh sửa booking cho Chủ nhà
    console.log("Host edit booking:", booking);
  };

  const handleDelete = (booking) => {
    // Logic xóa booking cho Chủ nhà
    console.log("Host delete booking:", booking);
  };
  ...
  return (
    <div className="flex min-h-screen bg-neutral-100 max-sm:flex-col">
      <Sidebar activePage="host-dashboard" />
